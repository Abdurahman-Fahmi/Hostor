...
public class Policy extends AppCompatActivity {
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (itemId == R.id.nav_home) {
            startActivity(new Intent(Policy.this, MainActivity.class));
        } else if (itemId == R.id.nav_account) {
            startActivity(new Intent(Policy.this, LoginActivity.class));
        } else if (itemId == R.id.nav_policy) {
            drawerLayout.closeDrawer(GravityCompat.START);
        } else if (itemId == R.id.nav_about) {
            startActivity(new Intent(Policy.this, AboutUs.class));
    ...
    private void showAlertDialog() {
        AlertDialog dialog = new AlertDialog.Builder(Policy.this)
